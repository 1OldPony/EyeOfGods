...
namespace EyeOfGods.Migrations
{
    ...
    [Migration("20230804182849_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWargame.Models.DefensiveAbilities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.EnduranceAbilities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.MeleeWeapon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.MentalAbilities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.RangeWeapon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.RangeWeaponsType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.Shield", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.UnitOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.UnitType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyWargame.Models.MeleeWeapon", b =>
                {
                    b.HasOne("MyWargame.Models.Unit", null)
            ...
            modelBuilder.Entity("MyWargame.Models.RangeWeapon", b =>
                {
                    b.HasOne("MyWargame.Models.RangeWeaponsType", "RangeWeaponsType")
            ...
            modelBuilder.Entity("MyWargame.Models.Unit", b =>
                {
                    b.HasOne("MyWargame.Models.DefensiveAbilities", "DefensiveAbilities")
                        .WithMany()
                        .HasForeignKey("DefensiveAbilitiesId");

                    b.HasOne("MyWargame.Models.EnduranceAbilities", "EnduranceAbilities")
                        .WithMany()
                        .HasForeignKey("EnduranceAbilitiesId");

                    b.HasOne("MyWargame.Models.MentalAbilities", "MentalAbilities")
                        .WithMany()
                        .HasForeignKey("MentalAbilitiesId");

                    b.HasOne("MyWargame.Models.RangeWeapon", "RangeWeapon")
                        .WithMany()
                        .HasForeignKey("RangeWeaponId");

                    b.HasOne("MyWargame.Models.Shield", "Shied")
                        .WithMany()
                        .HasForeignKey("ShiedId");

                    b.HasOne("MyWargame.Models.UnitType", "UnitType")
                        .WithMany()
            ...
            modelBuilder.Entity("UnitOrderUnitType", b =>
                {
                    b.HasOne("MyWargame.Models.UnitOrder", null)
                        .WithMany()
                        .HasForeignKey("UnitTypeOrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyWargame.Models.UnitType", null)
                        .WithMany()
