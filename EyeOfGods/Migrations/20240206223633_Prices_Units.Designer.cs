...
namespace EyeOfGods.Migrations
{
    ...
    [Migration("20240206223633_Prices_Units")]
    partial class Prices_Units
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EyeOfGods.Models.MapModels.TerrainOptions", b =>
                {
                    ...
                    b.Property<string>("OptionsSetName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SwampDensity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EyeOfGods.Models.MapModels.Map", b =>
                {
                    ...
                    b.OwnsMany("EyeOfGods.Models.MapModels.InterestPoint", "InterestPoints", b1 =>
                        {
                            ...
                            b1.ToTable("InterestPoint");

                            b1.WithOwner()
                                .HasForeignKey("MapId");
                        });

                    b.OwnsMany("EyeOfGods.Models.MapModels.Terrain", "Terrains", b1 =>
                        {
                            b1.Property<int>("MapId")
                                .HasColumnType("int");
                            ...
                            b1.Property<bool>("GodFrendly")
                                .HasColumnType("bit");

                            b1.Property<bool>("HasGodToken")
                                .HasColumnType("bit");
